...
<!DOCTYPE html>
 <html>
    ...
    var saveme =  $.ajax({
        type: "POST",
        url: "http://localhost:8080/listaTotalVentas", //nombre del archivo php que consultaremos.
    ...
    <table id="tabla" style="border: 2px solid darkslategrey; width: 600px; margin-left:auto; margin-right:auto; margin-bottom:auto;margin-top:auto;">
        <thead>
            <tr >
                <td colspan="3" style="background-color: lightslategrey; text-align:center">
                    <h1>Reporte Total Ventas por Cliente</h1>
                </td>
            </tr>
